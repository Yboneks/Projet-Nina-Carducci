(function ($) {
  ...
  $.fn.mauGallery.methods = {
    ...
    wrapItemInColumn(element, columns) {
      // On vérifie si le parent n'est pas déjà en colonne

      if (element.parent().hasClass("item-column")) {
        return;
      }
    ...
    prevImage(lightboxId) {
      ...
      $("img.gallery-item").each(function () {
        if ($(this).attr("src") === $(`#${id} .lightboxImage`).attr("src")) {
          activeImage = $(this);
        }
      });
      ...
      // On permet à l'index d'aller à l'image précèdente
    ...
    nextImage(lightboxId) {
      ...
      // On permet à l'index d'aller à l'image suivante
